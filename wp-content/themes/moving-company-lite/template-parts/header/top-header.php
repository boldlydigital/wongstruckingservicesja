...
<div class="top-bar <?php if( get_theme_mod( 'moving_company_lite_sticky_header') != '') { ?> header-sticky"<?php } else { ?>close-sticky <?php } ?>">
	<div class="container">
		<div class="row">
	        ...
	        <div class="col-lg-1 col-md-1 col-3">
	          	<div class="search-box">
	            	<a href="#" onclick="moving_company_lite_search_open()"><span><i class="fas fa-search"></i></span></a>
	          	</div>
	        </div>
	      	<?php }?>
		...
		<div class="serach_outer">
	        ...
	        <a href="#main" onclick="moving_company_lite_search_close()" class="closepop"><i class="fa fa-window-close"></i></a>
	    </div>
	</div>
</div>