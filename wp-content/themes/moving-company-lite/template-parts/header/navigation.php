...
<div id="header" class="menubar">
	<div class="container">
		<div class="toggle-nav mobile-menu">
		    <button role="tab" onclick="moving_company_lite_menu_open_nav()"><i class="<?php echo esc_attr(get_theme_mod('moving_company_lite_res_menu_open_icon','fas fa-bars')); ?>"></i><span class="screen-reader-text"><?php esc_html_e('Open Button','moving-company-lite'); ?></span></button>
		</div>
