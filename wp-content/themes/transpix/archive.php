        ...
        <div class="row">
           <div class="col-lg-8">
              <div class="breadcrumb-txt">
                 <h1><?php
                        if ( is_day() ) :
                            printf( esc_html__( 'Daily Archives : %s', 'transpix' ), get_the_date() );
                        elseif ( is_month() ) :
                            printf( esc_html__( 'Monthly Archives: %s', 'transpix' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'transpix' ) ) );
                        elseif ( is_year() ) :
                            printf( esc_html__( 'Yearly Archives: %s', 'transpix' ), get_the_date( _x( 'Y', 'yearly archives date format', 'transpix' ) ) );
                        else :
                            echo esc_html__( 'Archives', 'transpix' );
                        endif;?></h1>
              </div>
           </div>
        </div>
