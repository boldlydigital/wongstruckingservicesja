...
final class BdevsElementor {
	...
	*/
	...
	public function init_widgets() {
		...
		require_once plugin_dir_path( __FILE__ ) . 'widgets/multi-slider-widget.php';
		...
		require_once plugin_dir_path( __FILE__ ) . 'widgets/shortcode-form-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/partner-widget.php';
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsMultiSlider() );
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsPartner() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsFAQ() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsShortcodeForm() );
